...
const Events = () => {
  return (
    <>
      <div id="event" className="events_page">
        <h1>Upcoming Events</h1>
        <div className="event_cont">
          {/* event card */}
          <div className="event_card shadow-xl">
            <div className="img">
              <img src={chigar} alt="events" />
            </div>

            <div className="txt">
              <h3>Babar Bharat aaya 1491</h3>
          ...
          <div className="event_card shadow-xl">
            ...
            <div className="txt">
              ...
              <a
                className="w-full mt-4 text-center bg-[#2f8d46] border-solid border border-transparent text-m text-white border-solid rounded-xl py-2 px-7 hover:bg-transparent hover:text-[#2f8d46]  hover:border-[#2f8d37]"
                href="#"
              >
                {" "}
                Know more{" "}
